const swiper = new Swiper('.table_prise-services.swiper-container', {
    breakpoints:{
        320:{
            enabled: true,
            // Optional parameters
...
//     let tags = document.querySelectorAll(".swiper-slide");
...
//     let slides = document.querySelectorAll(".swiper-slide.extra");
