const swiper = new Swiper('.swiper-container.swiper-container__brand-repair', {
    breakpoints:{
        320:{
            enabled: true,
            // Optional parameters
...
document.addEventListener("DOMContentLoaded", function () {
    let tags = document.querySelectorAll(".logo__repair");
    let numTagsToApplyClass = 3;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let slides = document.querySelectorAll(".logo__repair.extra");
    let buttonText = button.querySelector(".repair__text-flex");

    button.addEventListener('click', function () {
        let numSlidesToToggle = 3;
